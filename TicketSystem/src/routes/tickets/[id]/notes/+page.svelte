...
<!-- HTML goes here -->
<main>
	<button class="backButton" on:click={() => goto(`/tickets`)}>
		<svg class="topBarSvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
	...
	<button class="addButton" on:click={() => togglePopup('new')}>
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="topBarSvg">
			<path
